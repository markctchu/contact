...
function ChatWindow({ messages, username, inputValue, activeAction }) {
  ...
  return (
    <div className="bg-surface-low rounded-xl p-2 sm:p-3 shrink-0 overflow-hidden border border-outline-variant flex flex-col h-32 sm:h-40">
      ...
      {/* 2. Persistent Chat Input Line (Fixed at bottom of box) */}
      {isChatInput && (
        <div className="flex items-baseline space-x-3 px-1 py-1 mt-1 border-t border-on-surface/5 shrink-0">

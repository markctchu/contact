...
- **Strict Prefix Logic:** All guesses must start with the currently revealed letters.
- **Contact Persistence:** If a **CONTACT** attempt fails (words don't match), the guess **remains active**, allowing further guesses or new contact attempts.
...
- **Dictionary Validation:** Validates secret words and guesses against a 178k+ word English dictionary (`words.txt`).
